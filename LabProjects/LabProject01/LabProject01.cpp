...
BOOL WINAPI AdjustWindowRect(LPRECT lprect, DWORD dwStyle, BOOL bMenu);//추가
...
{
    DWORD dwStyle = WS_OVERLAPPED | WS_CAPTION | WS_MINIMIZEBOX | WS_SYSMENU | WS_BORDER;//추가
    RECT rc = { 0, 0, 640, 480 };//추가
    AdjustWindowRect(&rc, dwStyle, FALSE);//추가

   HWND hWnd = CreateWindowW(szWindowClass, szTitle, dwStyle, CW_USEDEFAULT,
      CW_USEDEFAULT, rc.right - rc.left, rc.bottom - rc.top, NULL, NULL, hInstance, NULL);//추가
